...
const char font5x7[] = {
	//index is 6*(character - 0x20)
	/*
	number of char bytes

	int getNumberOfCharBytes(char c){
	int i = 6*(c - 0x20);
	...
	int getStartOffsetOfChar(char c){
	...
	*/
	...
	0x06, 0x5F, 0x06, 0x00, 0x00, 0x00,	// 0x21 - !
	...
	0x3E, 0x41, 0x00, 0x00, 0x00, 0x00,	// 0x28 - (
	0x41, 0x3E, 0x00,	0x00, 0x00, 0x00,	// 0x29 - )
	0x08, 0x3E, 0x1C, 0x3E, 0x08, 0x00,	// 0x2A - *
	0x08, 0x08, 0x3E, 0x08, 0x08, 0x00,	// 0x2B - +
	0xE0, 0x60, 0x00,	0x00, 0x00, 0x00,	// 0x2C - ,
	0x08, 0x08, 0x08, 0x08, 0x08, 0x00,	// 0x2D - -
	0x60, 0x60, 0x00,	0x00, 0x00, 0x00,	// 0x2E - .
	0x20, 0x10, 0x08, 0x04, 0x02, 0x00,	// 0x2F - /
	0x3E, 0x41, 0x41, 0x41, 0x3E, 0x00,	// 0x30 - 0
	0x42, 0x7F, 0x40, 0x00, 0x00, 0x00,	// 0x31 - 1
	0x62, 0x51, 0x49, 0x49, 0x46, 0x00,	// 0x32 - 2
	0x22, 0x49, 0x49, 0x49, 0x36, 0x00,	// 0x33 - 3
	0x18, 0x14, 0x12, 0x7F, 0x10, 0x00,	// 0x34 - 4
	0x2F, 0x49, 0x49, 0x49, 0x31, 0x00,	// 0x35 - 5
	...
	0x6C, 0x6C, 0x00,	0x00, 0x00, 0x00,	// 0x3A - :
	0xEC, 0x6C, 0x00,	0x00, 0x00, 0x00,	// 0x3B - ;
	...
	0x41, 0x7F, 0x41, 0x00, 0x00, 0x00,	// 0x49 - I
	...
	0x7F, 0x09, 0x09, 0x19, 0x66, 0x00,	// 0x52 - R
	...
	0x71, 0x49, 0x45, 0x43, 0x00,	0x00,	// 0x5A - Z
	0x7F, 0x41, 0x41, 0x00, 0x00, 0x00,	// 0x5B - [
	...
	0x07, 0x06, 0x00,	0x00, 0x00, 0x00,	// 0x60 - `
	...
	0x08, 0x7E, 0x09, 0x09, 0x00,	0x00,	// 0x66 - f
	0x18, 0xA4, 0xA4, 0xA4, 0x7C, 0x00,	// 0x67 - g
	0x7F, 0x04, 0x04, 0x78, 0x00,	0x00,	// 0x68 - h
	0x7D, 0x40, 0x00,	0x00, 0x00,	0x00,	// 0x69 - i
	0x40, 0x80, 0x84, 0x7D, 0x00,	0x00,	// 0x6A - j
	0x7F, 0x10, 0x28, 0x44, 0x00,	0x00,	// 0x6B - k
	0x7F, 0x40, 0x00,	0x00, 0x00, 0x00,	// 0x6C - l
	0x7C, 0x04, 0x18, 0x04, 0x78, 0x00,	// 0x6D - m
	0x7C, 0x04, 0x04, 0x78, 0x00,	0x00,	// 0x6E - n
	0x38, 0x44, 0x44, 0x44, 0x38, 0x00,	// 0x6F - o
	0xFC, 0x44, 0x44, 0x44, 0x38, 0x00,	// 0x70 - p
	0x38, 0x44, 0x44, 0x44, 0xFC, 0x00,	// 0x71 - q
	0x44, 0x78, 0x44, 0x04, 0x08, 0x00,	// 0x72 - r
	0x08, 0x54, 0x54, 0x54, 0x20, 0x00,	// 0x73 - s
	0x04, 0x3E, 0x44, 0x24, 0x00,	0x00,	// 0x74 - t
	0x3C, 0x40, 0x20, 0x7C, 0x00,	0x00,	// 0x75 - u
	0x1C, 0x20, 0x40, 0x20, 0x1C, 0x00,	// 0x76 - v
	0x3C, 0x60, 0x30, 0x60, 0x3C, 0x00,	// 0x77 - w
	0x6C, 0x10, 0x10, 0x6C, 0x00,	0x00,	// 0x78 - x
	0x9C, 0xA0, 0x60, 0x3C, 0x00,	0x00,	// 0x79 - y
	0x64, 0x54, 0x54, 0x4C, 0x00,	0x00,	// 0x7A - z
	0x08, 0x3E, 0x41, 0x41, 0x00,	0x00,	// 0x7B - {
	0x77, 0x00, 0x00, 0x00, 0x00, 0x00,	// 0x7C - |
	0x41, 0x41, 0x3E, 0x08, 0x00,	0x00,	// 0x7D - }
	0x02, 0x01, 0x02, 0x01, 0x00,	0x00,	// 0x7E - ~
	0x55, 0x00, 0x00, 0x00, 0x00, 0x00 // 0x7F used for unknown char filler
};
